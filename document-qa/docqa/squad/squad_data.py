...
class WeightedQuestion(Question):
    """ Question paired with its answer """

    def __init__(self, question_id: str, words: List[str], answer: ParagraphSpans, weight: float):
        super().__init__(question_id, words, answer)
        self.weight = weight
