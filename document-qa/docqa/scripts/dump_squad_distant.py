...
from docqa.data_processing.text_utils import NltkPlusStopWords, WordNormalizer
from docqa.squad.squad_data import SquadCorpus
from docqa.squad.squad_document_qa import SquadTfIdfRanker, SquadVectorTfIdfRanker
...
def parse_args():
  ...
  parser.add_argument('--use-vec-dist', '-v', action='store_true')
  parser.add_argument('--normalize-before-ranking', action='store_true')
